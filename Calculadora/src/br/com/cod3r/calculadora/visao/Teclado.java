...
public class Teclado extends JPanel implements ActionListener{
	...
	private final Color COR_CINZA_ESCURO = new Color(48,48,48);
	private final Color COR_CINZA_CLARO = new Color(59,59,59);
	private final Color COR_LARANJA_ESCURO = new Color(146,50,32);
...
//			ENTENDA: AQUI VC MANDA O VALOR DO BOTAO PARA O OBSERVADOR
